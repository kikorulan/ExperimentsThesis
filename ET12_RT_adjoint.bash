...
# Sound speed
SS=1500
export SOUND_SPEED="sound_speed_"$SS".dat"
...
#==============================
dt=4e-8
export FORWARD_SIGNAL_LOW="forwardSignal_kWave_"$SS"_low_"$dt".dat"
export FORWARD_SIGNAL_MID="forwardSignal_kWave_"$SS"_mid_"$dt".dat"
export FORWARD_SIGNAL_HIGH="forwardSignal_kWave_"$SS"_high_"$dt".dat"
echo "==================================== dt = 4e-8 ========================================="
# SENSORS LOW
...
mv $OUTPUT_FOLDER"/PixelPressure.dat" "adjoint_pressure_RT_"$SS"_low_"$dt.dat
# Mid pressure
...
mv $OUTPUT_FOLDER"/PixelPressure.dat" "adjoint_pressure_RT_"$SS"_mid_"$dt.dat
# High pressure
...
mv $OUTPUT_FOLDER"/PixelPressure.dat" "adjoint_pressure_RT_"$SS"_high_"$dt.dat
