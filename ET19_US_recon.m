...
cd /cs/research/medim/projects2/projects/frullan/Documents/HighFreqCode/ExperimentsThesis/Ex19_US;
...
positionY   = [700 700 500 450];
positionBar = [700 700 550 450];
...
pbaspect([1 1 1]);
if(saveFigures)
saveas(gcf, 'ET19_C', 'png');
saveas(gcf, 'ET19_C.fig');
end
...
pbaspect([1 1 1]);
if(saveFigures)
saveas(gcf, 'ET19_C_recon', 'png');
saveas(gcf, 'ET19_C_recon.fig');
end
